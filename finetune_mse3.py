"""Leak-proof minimum-symbolic-edit, ONE-new-token design (user's): only new vocab = '-'.
...
BATCH = 48; P1 = "runs_mse3/phase1.pt"
OUT = os.environ.get("OUT", f"runs_mse3/lam_{LAM:g}"); os.makedirs(OUT, exist_ok=True)
