...
ev = [D.make_ood_example(np.random.RandomState(7000 + i), 13, 20) for i in range(600)]
...
ax.set_title("Exp 2a (OOD) — which weight class carries each skill's quant penalty?\n(tall bar = that class's quantization is what hurt that skill)")
ax.legend(); ax.grid(axis="y", alpha=.3)
plt.tight_layout(); plt.savefig("runs/exp2a_ood.png", dpi=120)
print("\nsaved runs/exp3a_ood.png, runs/exp2a_ood.png")
